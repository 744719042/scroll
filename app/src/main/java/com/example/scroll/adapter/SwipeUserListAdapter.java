...
public class SwipeUserListAdapter extends BaseAdapter {
    private static final String TAG = "UserListAdapter";
    private Context context;
    private LayoutInflater inflater;
    private List<User> data;

    public SwipeUserListAdapter(Context context) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.data = users;
    }

    public SwipeUserListAdapter(Context context, List<User> users) {
        this(context);
        this.data = users;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.swipe_user_list, parent, false);
